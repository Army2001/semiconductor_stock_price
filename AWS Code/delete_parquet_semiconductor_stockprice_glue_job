...
BUCKET_TO_DEL = 'army-sc-bucket-parquet'
DATABASE_TO_DEL = 'semiconductorstock'
TABLE_TO_DEL = 'semiconductor_stock_price'
QUERY_OUTPUT_BUCKET = 's3://army-sc-query-results-bucket/'
